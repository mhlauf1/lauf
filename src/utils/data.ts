...
export const testimonialData = [
    ...
    },
    {
        ...
        quote: "Hiring Michael to design our new website was a fantastic decision – beginning with initial design and content ideas, all the way to making final edits and formally launching the site, Michael delivered exceptional service throughout the entire process. We are thrilled with the end product, and we truly believe the new site has played a pivotal role in the continued growth and success of Brady Digital Consulting.",
        client: {
